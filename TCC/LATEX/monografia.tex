...
\titulo{DESENVOLVIMENTO DE UM JOGO 2D QUE ABORDA TEMAS DE SAÚDE MENTAL UTILIZANDO FERRAMENTAS DE IA PARA O PROCESSO DE ANIMAÇÃO}
...
\input{chapters/ferramentasIA}
\input{chapters/conclusao}
\input{appendix/telas ferramentas}
